...
/**
 * SectionMatrix module version information
 *
g * @package    mod
...
$plugin->component = 'mod_sectionmatrix';     // Full name of the plugin (used for diagnostics)
$plugin->cron      = 0;
...
$module->component = 'mod_sectionmatrix';     // Full name of the plugin (used for diagnostics)
$module->cron      = 0;
*/
